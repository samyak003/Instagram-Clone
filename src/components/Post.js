...
function Post({ postId, uid, username, caption, imageUrl, profilePic }) {
	...
	return (
		<div className="bg-white max-w-lg w-full border dark:border-gray-400 mb-14 dark:bg-black dark:text-white rounded">
			...
			<img
				...
				src={imageUrl}
			></img>
			<h4 className="p-3 p-b-0" onClick={() => history.push(`/profile/${uid}`)}>
